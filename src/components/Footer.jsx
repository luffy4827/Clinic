  ...
  return (
    <footer className="flex flex-col lg:flex-row justify-between items-center gap-5 p-10 bg-gray-100 text-gray-700">
      <div className="order-1">
        ...
        <p className="mt-1 text-gray-600">Sunday - Friday: 7:00AM — 7:00PM</p>
        <p className="mt-1 text-gray-600">Saturday: 7:00AM to 10:00AM</p>
        <p className="mt-1">sunapatipolyclinic@gmail.com</p>
        <p className="mt-1">Call for Inquiry</p>
      </div>
      <nav className="order-3 lg:order-2">
        ...
        <nav className="flex flex-col justify-center items-center gap-3">
            ...
            <div>
              <p className="block">Copyright © 2024 - All rights reserved</p>
          </div>
        </nav>
      </nav>
      <div className="order-2 lg:order-3">
        <aside className="flex flex-col justify-center items-center gap-3">
          <img
            src={footer}
            className="w-20 h-20 bg-sky-500 rounded-full"
            alt=""
          />
